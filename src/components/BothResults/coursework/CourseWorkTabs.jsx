    ...
    <div>
      <div className="py-2  mx-auto  max-w-7xl ">
        <nav className="flex flex-col space-y-3 sm:space-y-0 sm:space-x-4 sm:flex-row sm:items-center">
          <div
            className={`cursor-pointer inline-flex border border-2 items-center px-10 py-2 text-sm font-medium ${
              activeTab === "all"
          ...
          <div
            className={`cursor-pointer inline-flex border border-2 items-center px-5 py-2 text-sm font-medium ${
              activeTab === "passed"
                ? "text-black bg-gray-300"
                : "text-gray-500 hover:text-gray-900"
            } transition-all duration-200 rounded-2xl group whitespace-nowrap`}
          ...
          <div
            className={`cursor-pointer inline-flex border border-2  items-center px-6 py-2 text-sm font-medium ${
              activeTab === "failed"
                ? "text-black bg-gray-300"
                : "text-gray-500 hover:text-gray-900"
            } transition-all duration-200 rounded-2xl group whitespace-nowrap`}
